...
public class MatrixState 
{
    ...
    public static void setModelViewMatrix(float []mvMatrix){
    ...
    {
    	float[] mMVPMatrix=new float[16];
    	//Matrix.multiplyMM(mMVMatrix, 0, mMVMatrix, 0, currMatrix, 0);
    	Matrix.multiplyMM(mMVPMatrix, 0, mProjMatrix, 0, mMVMatrix, 0);
    	//Matrix.multiplyMM(mMVPMatrix, 0, mMVPMatrix, 0, mMVMatrix, 0);
    	return mMVPMatrix;
    }
}
